...
export function transformCommandTransitions(type, skillPresetId, skillName, startReel = 0) {
...
export function commandTransitionsFor({ characterId, skillPresetId, skillName, startReel = 0, commandVariant = '' }) {
  ...
  if (characterId === 'son_goku') return skillPresetId ? transformCommandTransitions('猿', skillPresetId, skillName, startReel) : null;
  if (characterId === 'gyumao') return skillPresetId ? transformCommandTransitions('牛', skillPresetId, skillName, startReel) : null;
